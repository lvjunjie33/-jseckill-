...
public class SeckillServiceImpl implements SeckillService {
     ...
     * 执行秒杀
     */
    public SeckillExecution executeSeckill(long seckillId, long userPhone, String md5) throws SeckillException, IOException, TimeoutException {
     ...
     * 执行秒杀
     */
    public boolean executeSeckillTest(long seckillId, long userPhone, String md5){
       return accessLimitService.tryAcquireSeckill();
    }
